    ...
    <div className="bg-slate-900 text-white min-h-screen flex flex-col items-center justify-center p-4 antialiased overflow-hidden">
      ...
      <footer className="mt-12 text-center text-slate-500">
        <div className="flex justify-center items-center space-x-4 mb-4">
          <a href="https://github.com/JonaaaDev/portafolio-JonaaaDev" className="flex items-center text-slate-500 hover:text-white transition-colors duration-300 group">
